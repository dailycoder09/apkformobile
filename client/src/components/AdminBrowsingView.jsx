    ...
    <div className="browse-screen">
      ...
      <div className="browse-body">
        <p className="browse-notice">
          Shows domains visited across apps and browsers while monitoring is active on the
          child's device. This requires an always-visible VPN connection — Android shows this
          to whoever is using the phone, it isn't hidden. Encrypted DNS used by some apps may
          not appear here.
        </p>
